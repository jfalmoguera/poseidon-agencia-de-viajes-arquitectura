(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@ngneat/overview'), require('rxjs/operators'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@ngneat/hot-toast', ['exports', '@angular/common', '@angular/core', '@ngneat/overview', 'rxjs/operators', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.ngneat = global.ngneat || {}, global.ngneat['hot-toast'] = {}), global.ng.common, global.ng.core, global.i1, global.rxjs.operators, global.rxjs));
}(this, (function (exports, common, i0, i1, operators, rxjs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var HotToastComponent = /** @class */ (function () {
        function HotToastComponent(injector) {
